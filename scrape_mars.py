...
def init_browser():
    executable_path = {'executable_path': '/Users/Upama/Desktop/Mars_Scraping/chromedriver'}
...
def scrape():
    ...
    # --- Visit Mars Weather ---
    browser.visit('https://mars.nasa.gov/insight/weather/')
    ...
    weather_table = soup.find('table', class_='mb_table')
    
    
    # Grab the result
    mars_weather = print (weather_table)
